  ...
  <div class="shortTerm">
    ...
    <div class="page_cont1">
      <div class="title animation_hide" v-animate="{delay: 0, class:'amplify'}">
        <p>{{ $t('short_rule.title') }}</p>
      </div>
      <div class="text animation_hide" v-animate="{delay: 0, class:'amplify'}">{{ $t('short_rule.text1', {short_num: short_num}) }}</div>
    ...
    <div class="page_cont2 delay300 animation_hide" v-animate="{delay: 300, class:'fadeInUp'}">
      ...
      <div class="text">{{ $t('short_rule.cont2.text1_1') }} <a href="https://www.deeplink.cloud/node" target="_blank">https://www.deeplink.cloud/node</a> {{ $t('short_rule.cont2.text1_2') }}</div>
      <div class="text1">{{ $t('short_rule.cont2.text2_1') }}</div>
      <div class="btns">
        <div class="btn">
          <p class="btn_title">{{ $t('short_rule.cont2.text3_1') }}</p>
          <p class="btn_text">{{ $t('short_rule.cont2.text3_2') }}</p>
        </div>
        <div class="btn">
          <p class="btn_title">{{ $t('short_rule.cont2.text4_1') }}</p>
          <p class="btn_text">{{ $t('short_rule.cont2.text4_2') }}</p>
        </div>
      </div>
      <div class="require">
        <div class="req_text1">
          <p class="text_top">{{ $t('short_rule.cont2.text5_1') }}</p>
          <p class="text_bottom">{{ $t('short_rule.cont2.text5_2') }}</p>
        </div>
        <div class="req_text2">
          <p class="text_top">{{ $t('short_rule.cont2.text6_1') }}</p>
          <p class="text_bottom">{{ $t('short_rule.cont2.text6_2') }}</p>
        </div>
        <div class="req_text2">
          <p class="text_top">{{ $t('short_rule.cont2.text7_1') }}</p>
          <p class="text_bottom">{{ $t('short_rule.cont2.text7_2') }}</p>
        </div>
        <div class="req_text2">
          <p class="text_top">{{ $t('short_rule.cont2.text8_1') }}</p>
    ...
    <div class="page_cont3 delay300 animation_hide" v-animate="{delay: 300, class:'fadeInUp'}">
      ...
      <div class="title">{{ $t('short_rule.cont3.title') }}</div>
      <div class="text">{{ $t('short_rule.cont3.text') }}</div>
      <div class="page_cont">
        <el-scrollbar>
          <div class="cont_table">
            <table class="table_cont">
              <tr class="theader">
                <th class="">{{ $t('long_rule.cont3.li1') }}</th>
                <th class="">{{ $t('long_rule.cont3.li2') }}</th>
                <th class="">{{ $t('long_rule.cont3.li3') }}</th>
                <th class="">{{ $t('long_rule.cont3.li4') }}</th>
                <th class="">{{ $t('long_rule.cont3.li5') }}</th>
                <th class="">{{ $t('long_rule.cont3.li6') }}</th>
    ...
    <div class="page_cont4 delay300 animation_hide" v-animate="{delay: 300, class:'fadeInUp'}">
      ...
      <div class="text2">
        <div class="text_select">
          <p class="text2_tx">{{ $t('short_rule.cont4.text2') }}</p>
          <el-select class="el-select-type select_width" v-model="gpu_type1" :placeholder="$t('short_rule.cont4.text6')" @change='SelectGPU1'>
            <el-option v-for="(item, index) in options " :key="item.value" :label="item.name + '-Mem:' + item.men" :value="item.cuda+'_'+item.men+'_'+item.large+'_'+index"></el-option>
          </el-select> 
        </div>
        <!-- <div class="text_select">
        ...
        <div class="text_select">
          ...
          <el-select class="select_width210" v-model="mem_num1" :placeholder="$t('short_rule.cont4.text6')" @change='SelectMem1'>
    ...
    <div class="page_cont5 delay300 animation_hide" v-animate="{delay: 300, class:'fadeInUp'}">
      ...
      <div class="text">{{ $t('short_rule.cont5.text9') }}</div>
      ...
      <div class="text">
        ...
        <div class="formula">
          ...
          <div class="fraction">
            <div class="numerator">H<sub>i</sub>&nbsp;&middot;&nbsp;T<sub>i</sub>&nbsp;&middot;&nbsp;ln(max(1000, P<sub style="font-size:12px">i</sub>))</div>
            <div class="denominator">
                &sum;<sup>N</sup><sub style="margin-left: -10px;">j=1</sub> H<sub>j</sub> &middot; T<sub>j</sub>&nbsp;&middot;&nbsp;ln(max(1000, P<sub style="font-size:12px">j</sub>))
            </div>
          </div>
      ...
      <div class="text">
        ...
        <p>P<sub>i</sub>：{{ $t('short_rule.cont5.text13') }}</p>
        <p>H<sub>i</sub>：{{ $t('short_rule.cont5.text14') }}</p>
        <p>T<sub>i</sub>：{{ $t('short_rule.cont5.text15') }}</p>
      </div>
      <div class="title1">{{ $t('short_rule.cont5.title1') }}</div>
      <div class="text">
        <p>{{ $t('short_rule.cont5.text1_1') }}</p>
        <p>{{ $t('short_rule.cont5.text1_2') }}</p>
        <p>{{ $t('short_rule.cont5.text1_3') }}</p>
        <p>{{ $t('short_rule.cont5.text1_4') }}</p>
      </div>
      ...
      <div class="require">
        ...
        <div class="req_text3">
          ...
          <p class="text_bottom">{{ $t('short_rule.cont5.req_text2') }}</p>
        </div>
        <div class="req_text3">
          <p class="text_top">{{ $t('short_rule.cont5.req_title3') }}</p>
          <p class="text_bottom">{{ $t('short_rule.cont5.req_text3') }}</p>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const selectlocal_num2 = ref(1)  // 大模型系数 
      ...
      const DayDLCIncome = () => {
        ...
        &&join_gpu_num.value) {
          ...
          const result = Math.log(Math.max(1000, 10000))
