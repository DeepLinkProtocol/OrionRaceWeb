export default {
  ...
  short_rule: {
    ...
    cont5: {
      ...
      text10:
        '这个系统的奖励每天的总token数量是固定的，机器获得奖励与机器的算力值X以及机器加入挖矿的有效时间Y,以及机器的质押Token数量有关系，质押的Token越多奖励越多，但是不能呈现线性增长关系。0-1000个币奖励基数是一样的，当超过1000个币奖励与函数呈现关联.如果机器处于被租用状态算力值增加30%  ',
      text11: '奖励计算公式：',
      text12: 'R：每天的总奖励Token数量（固定值）',
      text13: '第i台机器的质押Token数量',
      text14: '第i台机器的算力值',
      ...
      text1_4:
        '4）10000个币的奖励是质押1000个币的1.23026倍，即大约增加了23.03%，10万个币的奖励是质押1000个币的1.46052倍，即大约增加了46.05%，质押100万个币的奖励是质押1000个币的1.69078倍，即大约增加了69.08%，质押1000万个币的奖励是质押1000个币的1.92103倍，即大约增加了92.10%',
